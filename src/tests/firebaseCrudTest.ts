...
const runTests = async () => {
  ...
  try {
    ...
    const invoice1 = loadJsonFile(path.join(__dirname, '../../../004207D5-F1E8-4E90-B997-459D17FADE01.json'));
    const invoice2 = loadJsonFile(path.join(__dirname, '../../../FA58FED6-8345-4312-A93A-76035C8B08F8.json'));
